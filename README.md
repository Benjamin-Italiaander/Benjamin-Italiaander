...
<h3>✔️ Enabling organizations to take back control of their data using open-source</h3>
...
>
> I’m fortunate to contribute to this vision at  
> :contentReference[oaicite:0]{index=0} (CWI).
...
- ML-KEM (Hybrid KEX for SSH)  
- NTRU Prime (SSH integration)
...
You can find the publications I contributed to at:
- **PLOS**: [journals.plos.org](https://journals.plos.org)  
